...
If you have any issues with the underling library make an issue on the library's [Github](https://github.com/D0A1V2I3D/EpicAuth-rust)

[Old library](https://github.com/EpicAuth/EpicAuth-Rust-Example/tree/backupoldapi)
